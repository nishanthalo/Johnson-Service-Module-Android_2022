...
public class PasusedListAdapter_PreventiveMR extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PasusedListAdapter_PreventiveMR(Context context, List<Pasused_ListResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener, String status) {
