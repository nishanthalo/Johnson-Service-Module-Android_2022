...
import com.triton.johnson_tap_app.Service_Activity.Preventive_Services.Preventive_Maintance_ListActivity;
import com.triton.johnson_tap_app.Service_Activity.Preventive_Services.Preventive_ServiceActivity;
...
//            holder.failure_count.setText(currentItem.getFailur_count());
        ...
        holder.ll_root.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(s.equals("Breakdown Serivce")) {
                    Intent n_act = new Intent(context, Preventive_ServiceActivity.class);
                    n_act.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    n_act.putExtra("service_title", s);
                    context.startActivity(n_act);
                }
               else if(s.equals("Preventive Maintenance")) {
                    Intent n_act = new Intent(context, Preventive_Maintance_ListActivity.class);
                    n_act.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    n_act.putExtra("service_title", s);
                    context.startActivity(n_act);
                }
