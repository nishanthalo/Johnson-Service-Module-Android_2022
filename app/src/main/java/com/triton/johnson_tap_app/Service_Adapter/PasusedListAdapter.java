...
public class PasusedListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PasusedListAdapter(Context context, List<Pasused_ListResponse.DataBean> breedTypedataBeanList, PetBreedTypeSelectListener petBreedTypeSelectListener ) {
